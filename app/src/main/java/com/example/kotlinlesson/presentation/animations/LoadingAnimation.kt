package com.example.kotlinlesson.presentation.animations
...
class LoadingAnimation constructor(private val context: Activity, animationName: String) {
    ...
    private var rLayoutParams :
            RelativeLayout.LayoutParams = RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.FILL_PARENT, RelativeLayout.LayoutParams.FILL_PARENT)

    private val lLayoutParams :
            RelativeLayout.LayoutParams = RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT)
    init {
